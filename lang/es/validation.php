...
return [
    ...
    */
    ...
    'missing_if' => 'El campo :attribute debe estar vacío cuando :other es :value.',
    'missing_unless' => 'El campo :attribute debe estar vacío a menos que :other sea :value.',
    'missing_with' => 'El campo :attribute debe estar vacío cuando :values está presente.',
    'missing_with_all' => 'El campo :attribute debe estar vacío cuando :values están presentes.',
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado se ha filtrado en una brecha de datos. Elige un :attribute diferente.',
    ],
    ...
    */
    ...
    'custom' => [
        'image' => [
            'image' => 'El archivo debe ser una imagen (JPG, PNG, GIF, WEBP o SVG).',
            'mimes' => 'La imagen debe tener formato: :values.',
            'max' => 'La imagen no puede pesar más de 2 MB. Probá con una versión más liviana o de menor resolución.',
            'uploaded' => 'La imagen no se pudo subir. Puede ser demasiado pesada (máx. 2 MB).',
